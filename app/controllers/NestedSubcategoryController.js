...
exports.allnestedsubcategory = async (req, res, next) => {
    ...
    if (nestedsubcategoryData) {
        return res.json(constants.responseObj(true, 200, constants.messages.Success, false, nestedsubcategoryData))
    } else {
        return res.json(constants.responseObj(false, 202, constants.messages.NoNestedSubcategory))
    }
}
