const { DoctorsModel, MedicineFormModel,MedicineStrengthModel, ReminderFrequencyModel, ReminderTimeModel , MedicineReminderModel} = require('../imports');
...
exports.getMedicineReminderList = async (req, res, next) => {    
    try {
        ...
        return res.json(constants.responseObj(true, 201, constants.messages.DataFound,false,{DoctorsData,MedicineData,MedicineStrengthData,ReminderFrequencyData,ReminderFrequencyData,ReminderTimeData}))
    ...
    try {
        ...
        imageUpload(medicine_image,imgAttachement,async function(err, images){
            if(err){
                ...
                return res.json(constants.responseObj(false, 422, constants.messages.InvalidFile))

            }else{
                let medicineReminderData = { user_id: req.body.user_id, referred_by_doctor: req.body.referred_by_doctor, medicine_name: req.body.medicine_name, medicine_image:images.image ,medicine_form:req.body.medicine_form,dose:req.body.dose,medicine_strength:req.body.medicine_strength,medicine_strength_unit:req.body.medicine_strength_unit,reminder_frequency:req.body.reminder_frequency,frequency_value:req.body.frequency_value,reminder_time:req.body.reminder_time,user_selected_time:req.body.user_selected_time,pills_remaining:req.body.pills_remaining,status:true}
